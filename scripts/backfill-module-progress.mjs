 ...
 *
 * Usage:
 *  SUPABASE_URL=... SUPABASE_SERVICE_ROLE_KEY=... node scripts/backfill-module-progress.mjs
 *
...
async function deriveProgress(userId) {
  const results = [];
...
async function upsertProgress(records) {
