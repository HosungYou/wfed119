    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-5xl mx-auto px-4 py-10">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-700">Select one of the three value sets to start your sorting activity.</p>
        </div>
        <div className="grid sm:grid-cols-3 gap-6">
          <Link href="/discover/values/terminal" className="group block bg-white border rounded-2xl p-6 hover:shadow-md transition">
            ...
            <div className="text-sm text-gray-700">Values tied to your ultimate life purpose</div>
          </Link>
          <Link href="/discover/values/instrumental" className="group block bg-white border rounded-2xl p-6 hover:shadow-md transition">
            ...
            <div className="text-sm text-gray-700">Behaviors and attitudes that help you reach your goals</div>
          </Link>
          <Link href="/discover/values/work" className="group block bg-white border rounded-2xl p-6 hover:shadow-md transition">
            ...
            <div className="text-sm text-gray-700">What you need from your workplace and teammates</div>
          </Link>
        </div>
        <div className="mt-8 text-xs text-gray-700">When you save your selections, we store the layout to personalize future modules.</div>
      </main>
    </div>
  );
}
